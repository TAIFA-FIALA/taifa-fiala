...
async def get_stage_matched_announcements(
    ...
    This endpoint helps founders find announcements appropriate for their current funding stage.
    """
    # In a real implementation, this would query the database based on the parameters
    # For demo purposes, we'll return representative stage-appropriate announcements
    ...
    # Match announcements based on stage
    if current_stage == "Pre-seed":
        ...
        announcements = [
            ...
            },
            {
                ...
                "deadline": "2024-09-05",
                "stage_appropriate": True,
                "requirements": "Product-market fit, growth metrics",
                "success_rate": "6%",
                "application_complexity": "High"
            }
        ]
        ...
        announcements = [
            {
                ...
                "funding_amount": "$500k - $2 million",
                "deadline": "Rolling applications",
                "stage_appropriate": True,
                "requirements": "Proven revenue, scalable model",
                "success_rate": "4%",
    ...
    if domain:
        ...
        announcements = announcements[:2]  # Just return fewer items to simulate filtering
